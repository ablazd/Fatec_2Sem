...
('Ana Laura Lazdenas', 2024-01-03, 2600.00);

select * from Empregado

insert into Empregado values
('Julia Soares', '22/08/03', 3100.00);

select * from Empregado

insert into Empregado values
('Eduarda Brandini', '2023-01-03', 4500.00);

insert into Empregado values
('Murilo Santos', '2020-01-12', 3000.00),
('Felipe Santos', '2021-10-03', 2100.00);

/*seleciona apenas os estados das cidades cadastradas*/
select distinct cdEstado from Cidade

/*seleciona os tipos de unidades na tabela produtos*/
...
/*listar o codigo e o nome de cada cliente*/
select 'Código do cliente', cod_cliente, nome_cliente as 'Nome do Cliente'
from cliente
...
select 'Funcionario: '+nome+' Salario: '+convert(VARCHAR, salario) as 'Fusao', salario, nome
from Empregado

/*listar num do pedido, codigo do produto e quantidade dos itens do pedido com quantidade igual 45*/
select num_pedido, cod_produto, quantidade
from item_pedido
where quantidade=45

/*listar funcionarios que trabalham no setor de codigo 2
select numMatricula, primeiro_nome, ultimo_nome, cod_setor
from Empregado
where cod_setor=2*/
